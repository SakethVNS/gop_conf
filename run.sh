...
# model=exp_nnet3/nnet3_cleaned/tdnn_sp
...
# lang=$data/lang_gop_400_ex_noise
...
train=dec_gop_572 # English data
test=""
...
# Using only phone sequences and not using time alignments
if [ $stage -le 6 ]; then
    get_align.sh --stage 3 --nj $nj $data/$train $lang $exp $data/$train/alignments
