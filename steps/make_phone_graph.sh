...
if [ $# -ne 3 ]; then
  ...
  echo "Makes the graph in <model-dir>/phone_graph, corresponding to the model in <model-dir>"
  echo "The alignments from <alignment-dir> are used to train the phone LM."
  exit 1;
fi
