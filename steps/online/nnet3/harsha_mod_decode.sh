...
beam=14.0
lattice_beam=16.0
acwt=0.15  # note: only really affects adaptation and pruning (scoring is on
           # lattices).
...
scoring_opts=
skip_scoring=false
silence_weight=0 # set this to a value less than 1 (e.g. 0) to enable silence weighting.
